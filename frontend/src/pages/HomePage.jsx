...
const HomePage = () => {
    ...
    return (
        <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg-main)' }}>
            ...
            {/* Todo sidebar — rendered at root level so it overlays everything */}
            ...
            <div style={{ maxWidth: '900px', margin: '0 auto', padding: isMobile ? '24px 16px' : '40px 24px' }}>
                ...
                {/* Welcome + Tasks button */}
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '32px', gap: '16px' }}>
                    <div>
                        <h1 style={{ fontSize: isMobile ? '24px' : '30px', fontWeight: '800', color: 'var(--text-primary)', marginBottom: '6px' }}>
                            Welcome back,{' '}
                    ...
                    <button
                        ...
                        onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--accent)'; e.currentTarget.style.boxShadow = '0 4px 20px var(--shadow-md)'; }}
                        onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--glass-border)'; e.currentTarget.style.boxShadow = '0 2px 12px var(--shadow)'; }}
                    >
                        📋 <span style={{ whiteSpace: 'nowrap' }}>{isMobile ? 'Tasks' : 'Study Tasks'}</span>
                    </button>
                </div>
