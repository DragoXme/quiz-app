        ...
        <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg-main)' }}>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    ...
                    <div style={{
                        fontSize: '20px', fontWeight: '800', color: timerColor,
            ...
            <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '24px', display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
                {/* Question Panel */}
                <div style={{ flex: 1 }}>
                    <div style={{
                        ...
                        {currentQ?.questionText && (
                            <p style={{ fontSize: '16px', color: 'var(--text-primary)', lineHeight: '1.7', marginBottom: '24px', fontWeight: '500' }}>
                                {currentQ.questionText}
                            </p>
                        )}
                        {currentQ?.questionImageUrl && (
                            <img src={currentQ.questionImageUrl} alt="Question"
                                style={{ maxWidth: '100%', borderRadius: '8px', marginBottom: '24px', display: 'block' }} />
                        )}
                        ...
                        {currentQ?.type === 'mcq_multiple' && (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                <p style={{ fontSize: '13px', color: 'var(--text-muted)', marginBottom: '4px' }}>Select all correct answers</p>
                                {currentQ.options?.map((opt, idx) => (
                                    <div key={opt.id}
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '28px', gap: '12px' }}>
                            <button onClick={() => handleQuestionSwitch(currentIndex - 1)}
                                disabled={currentIndex === 0} style={{
                                    padding: '10px 24px', backgroundColor: 'var(--bg-card)',
